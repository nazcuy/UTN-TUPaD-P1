#TRABAJO PRÁCTICO NRO 3 - PROGRAMACIÓN 1 - UTN
...
nota = float(input("Escriba su nota (entre 0 y 10) para saber si aprobó o no: "))
if nota >= 6:
    print("Aprobado")
else:
    print("Desaprobado")
...
if edadPersona < 12:
    print("Usted es niño/a: menor de 12 años.")
elif edadPersona >= 12 and edadPersona < 18:
    print("Usted es adolescente: mayor o igual que 12 años y menor que 18 años.")
elif edadPersona >= 18 and edadPersona < 30:
    print("Usted es adolescente: mayor o igual que 12 años y menor que 18 años.")
else:
    print("Usted es adulto/a: mayor o igual que 30 años.")
...
contrasenia = input("Ingrese su contraseña. Debe tener entre 8 y 14 caracteres: ")
...
calcule su moda, su mediana y su media(promedio) y las compare para determinar 
...
hemisf = input("Ingrese en qué hemisferio se encuentra (N/S): ").upper()
...
if hemisf == "N":
    ...
    print("Ingresó mal el hemisferio.")